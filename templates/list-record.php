<?php
	...
	*/
	...
	function list_title() {
		...
		<tr>
			<td id="cb" class="manage-column column-cb check-column">
				<label class="screen-reader-text" for="cb-select-all-1">全选</label><inputid="cb-select-all-1" type="checkbox">
			</td>
			<th scope="col" id="title" class="manage-column column-title column-primary sortable desc">
				<a href="http://192.168.2.162/wp-admin/edit.php?orderby=title&order=asc">
	...
	<th scope="row" class="check-column">
		<label class="screen-reader-text" for="cb-select-1">选择世界，您好！ </label>
		<input id="cb-select-1" type="checkbox" name="post[]" value="1">
		<div class="locked-indicator">
			<span class="locked-indicator-icon" aria-hidden="true"></span>
			<span class="screen-reader-text">“世界，您好！”已被锁定 </span>
		</div>
	</th>
	<td class="title column-title has-row-actions column-primary page-title" data-colname="标题">
		...
		<div class="hidden" id="inline_1">
			...
			<div class="post_category" id="category_1">
				1
			</div>
			<div class="tags_input" id="post_tag_1">
			</div>
			<div class="sticky">
			</div>
		...
		<div class="row-actions">
			<span class="edit"><a href="http://192.168.2.162/wp-admin/post.php?post=1&action=edit"aria-label="编辑“世界，您好！”">编辑</a> | </span>
			<span class="inline hide-if-no-js"><button type="button" class="button-link editinline" aria-label="快速编辑“世界，您好！”" aria-expanded="false">快速编辑</button> |</span>
			<span class="trash"><a href="http://192.168.2.162/wp-admin/post.php?post=1&action=trash&_wpnonce=74a69df3c2" class="submitdelete" aria-label="移动“世界，您好！”到垃圾箱">移至回收站</a> | </span>
			<span class="view"><a href="http://192.168.2.162/index.php/2018/05/18/hello-world/" rel="bookmark" aria-label="查看“世界，您好！”">查看</a></span>
		</div>
		<button type="button" class="toggle-row"><span class="screen-reader-text">显示详情</span></button>
	</td>
	<td class="author column-author" data-colname="作者">
		<a href="edit.php?post_type=post&author=1">zhouliangshun</a>
	</td>
	<td class="date column-date" data-colname="日期">
		<abbr title="2018/05/18 20:02:49">2小时前</abbr>
	</td>
</tr>
			');
	}
	...
	<div class="wrap">
		...
		<h1 class="wp-heading-inline"> <?=esc_html(get_admin_page_title()); ?> </h1>
			...
			<ul class="subsubsub">
				<!-- <li class="all"><a href="edit.php?post_type=post" class="current"
					aria-current="page">全部<span class="count">（1）</span></a> |</li> -->
			<!-- <li class="publish"><a
				href="edit.php?post_status=publish&post_type=post">已发布<span class="count">（1）</span></a></li>
		-->
	</ul>
	...
	<form id="posts-filter" method="get">
		...
		<div class="tablenav top">
			...
			<div class="alignleft actions bulkactions">
				...
				<select name="action" id="bulk-action-selector-top">
					...
					<div class="tablenav-pages one-page">
						...
						<span class="pagination-links">
							...
							<span class="tablenav-pages-navspan button disabled" aria-hidden="true">‹</span>
							<span class="paging-input">第<label for="current-page-selector"
									class="screen-reader-text">当前页</label>
								<input class="current-page" id="current-page-selector" type="text"
									name="paged" value="1" size="1" aria-describedby="table-paging">
				...
				<!-- 列表 -->
				<h2 class="screen-reader-text">记录列表</h2><table class="wp-list-table widefat fixed striped posts">
					<thead>
						<?php list_title();?>
					</thead>
						<tbody id="the-list">
				...
				<form method="get"><table style="display: none"><tbody id="inlineedit">
								...
								none"><td colspan="7" class="colspanchange">
									...
									<fieldset class="inline-edit-col-center inline-edit-categories"><div
											...
											<ul class="cat-checklist category-checklist">
												...
												<li id="category-1" class="popular-category"><label
														class="selectit"><input value="1" type="checkbox"
															name="post_category[]" id="in-category-1"> 未分类</label></li>
											</ul>
									...
									<div class="submit inline-edit-save">
										...
										<input type="hidden" id="_inline_edit" name="_inline_edit"
											value="194430ed2a"> <button type="button" class="button
											button-primary save alignright">更新</button>
							...
							<tr id="bulk-edit" class="inline-edit-row inline-edit-row-post
								bulk-edit-row bulk-edit-row-post bulk-edit-post"style="display: none"><td
									...
									<fieldset class="inline-edit-col-right"><label
											class="inline-edit-tags">
											<span class="title">标签</span>
											<textarea data-wp-taxonomy="post_tag" cols="22" rows="1"
												name="tax_input[post_tag]" class="tax_input_post_tag"></textarea>
